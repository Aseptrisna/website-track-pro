...
const highlights = [
  { icon: MapPin, text: 'Real-time GPS tracking for your entire fleet' },
  { icon: Shield, text: 'Geofence alerts & security monitoring' },
  { icon: BarChart3, text: 'Advanced analytics & detailed reports' },
];
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-lg text-emerald-100">
              Get complete visibility of your vehicles in real-time with our powerful tracking platform.
            </p>
